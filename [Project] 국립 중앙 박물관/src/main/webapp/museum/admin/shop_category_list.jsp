...
<div class="add">
<a id="title">상품 카테고리 등록</a>
<div style="padding-bottom:10px"></div>
<form method="post" action="">
<table cellspacing="0" width="80%" id="AddForm">
	<tr>
		<td width="14%" align="center">상품 카테고리 코드</td>
		<td width="20%"><input type="text" id="text" name="ccode"></td>
		<td width="2%"></td>
		<td width="14%" align="center">상품 카테고리 이름</td>
...
<%
	...
	ArrayList<ShopCategoryDTO> lists = scdao.getAllShopCategory();
%>
<div class="view">
<a id="title"> 상품 카테고리 목록</a>&ensp;
...
<%
	for(ShopCategoryDTO scdto : lists) {
%>
	<tr>
		<td><%=scdto.getGcnum()%></td>
		<td><%=scdto.getGccode()%></td>
		<td><%=scdto.getGcname()%></td>
		<td><a href="">수정</a></td>
		<td><a href="">삭제</a></td>
	</tr>
<%
