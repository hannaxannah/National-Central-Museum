...
<input type="hidden" name="condition" value="예약완료">
	<table border="1">
		...
		<tr>
			<td>관람 일자</td>
			<td><input type="date" name="rdate" id="currentDate" max="2025-12-31" min="2023-01-01" value=""></td>
		</tr>
		<tr>
			<td>관람 시간</td>
			<td>
		...
		<tr>
			<td>예약자 이름</td>
			<td><input type="text" id="text_reser" name="rname" value="<%=mdto.getName()%>"></td>
			<!-- 로그인 했을 시, 로그인 정보에서 가져오기 -->
		</tr>
		<tr>
			<td>연락처</td>
			<td>
				<input type="text" id="text_reser3" name="hp1" value="<%=mdto.getHp1()%>">
				<input type="text" id="text_reser3" name="hp2" value="<%=mdto.getHp2()%>">
				<input type="text" id="text_reser3" name="hp3" value="<%=mdto.getHp3()%>">
			</td>
			<!-- 로그인 했을 시, 로그인 정보에서 가져오기 -->
		</tr>
		<tr>
			<td>이메일</td>
			<td><input type="email" id="text_reser" name="email" value="<%=mdto.getEmail()%>"></td>
			<!-- 로그인 했을 시, 로그인 정보에서 가져오기 -->
		</tr>
	</table>
